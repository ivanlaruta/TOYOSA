                ...
                <div class="x_panel">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>
                        @foreach($env as $envs)
                        <tr class='clickable-row' data-href="{{ route('envios.detalle',$envs-> id_solicitud )}}" >                
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>
                        ...
                        <tr class='clickable-row' data-href="{{ route('envios.detalle',$envs1-> id_solicitud )}}" >                
                      ...
                      <tbody>
                        ...
                        <tr @if($envs2 -> estado == '3') class="clickable-row danger" @endif
                          ...
                          <td>
                            ...
                            @if($envs2 -> estado == '4')Envio Incompleto @endif
