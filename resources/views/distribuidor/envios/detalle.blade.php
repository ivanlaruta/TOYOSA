            ...
            <div class="page-title">
              <div class="title_left">
                ...
                @if($env->estado == '1')<a href="{{ route('envios.index')}}">BORRADORES /  </a>@endif
                    ...
                    @if($env->estado == '4')<a href="{{ route('envios.index')}}">APROBADOS - ENVIADOS PARCIALMENTE /  </a>@endif
                    @if($env->estado == '5')<a href="{{ route('envios.index')}}">APROBADOS - ENVIADOS COMPLETOS /  </a>@endif
                    ENVIO {{$env->id_solicitud}} 
                  ...
                  <div  class="x_content" @if(is_null($request->marca))  style="display: none;"  @endif>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="col-md-4">
                        ...
                        {!! Form::open(array('route' => ['envios.detalle',$env->id_solicitud], 'method' => 'get','class' => 'form-horizontal form-label-left')) !!}﻿
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        {!! Form::open(array('route' => ['envios.addDetalle',$env->id_solicitud], 'method' => 'get','class' => 'form-horizontal form-label-left')) !!}﻿
                     ...
                     <div class="table-responsive">
                      ...
                      <tbody>
                        ...
                        <div class="btn-group">
                          ...
                          <a href="{{ route('envios.quitar_detalle',['id'=>$env->id_solicitud,'id2'=>$dets -> id_detalle ] )}}" class="btn btn-danger btn-round btn-xs" data-toggle="tooltip" data-placement="bottom" title="Quitar Seleccion" ><i class="fa fa-trash-o"></i></a> 
                          @endif
